          ...
          {webGLSupported ? (
            ...
            <>
              <motion.h1
                ...
                className="font-dm-serif text-4xl md:text-7xl lg:text-8xl xl:text-9xl text-gradient-gold mb-6 md:mb-8 tracking-wider leading-tight font-bold transform-gpu"
                style={{
                  transformStyle: 'preserve-3d',
              ...
              <motion.p
                ...
                className="font-dm-serif text-lg md:text-xl lg:text-2xl text-white max-w-2xl mx-auto leading-relaxed mb-0 px-2 md:px-4 font-medium tracking-wider transform-gpu"
                style={{
                  transformStyle: 'preserve-3d',
                  textShadow: isHovered 
