          ...
          {webGLSupported ? (
            ...
            <>
              <motion.h1
                ...
                className="font-display text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-gradient-gold mb-6 md:mb-8 tracking-wide leading-tight font-bold transform-gpu"
                style={{
                  transformStyle: 'preserve-3d',
              ...
              >
                <span className="block leading-tight text-gradient-white text-4xl md:text-5xl lg:text-6xl font-luxury">Premium Real Estate</span>
                <span className="block mt-6 md:mt-8 lg:mt-10 text-gradient-gold text-xl md:text-2xl lg:text-3xl leading-tight font-gretta">Reimagined for Tomorrow</span>
              </motion.h1>
              ...
              <motion.p
                ...
                className="font-serif text-sm md:text-base lg:text-lg text-gradient-gold max-w-2xl mx-auto leading-relaxed mb-0 px-2 md:px-4 font-medium transform-gpu"
                style={{
                  transformStyle: 'preserve-3d',
                  textShadow: isHovered 
